...
const SINGLE_TAXEL_QUANTA = 1.5;
/** Post-release residual gate (Zheng's rule 1, 2026-09-03; applied in
 * applyAdaptiveBaseline so the detector AND the corrected display see it;
...
export function buildSeriesFromSensorFrames(
  ...
  const quantumN = Number.isFinite(quantum) ? quantum : undefined;
